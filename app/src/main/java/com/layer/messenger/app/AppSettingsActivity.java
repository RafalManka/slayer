...
import com.layer.messenger.layer.providers.client.LayerDeauthenticationCallbacks;
                ...
                new AlertDialog.Builder(AppSettingsActivity.this)
                        ...
                        .setPositiveButton(R.string.alert_button_logout, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                progressDialog.show();
                                try {
                                    LayerClientProvider.deauthenticate(new LayerDeauthenticationCallbacks() {
                                        @Override
                                        public void onError(String s) {
                                            if (Log.isLoggable(Log.VERBOSE)) {
                                                Log.v("layer could not be initialized.");
                                            }
                                        }
                                        ...
                                        public void onDeauthenticationSuccess(LayerClient client) {
                                            ...
                                            setEnabled(true);
                                            try {
                                                LayerClientProvider.routeLogin(AppSettingsActivity.this);
                                            } catch (Exception e) {
                                                Log.e("Layer could not be initialize.");
                                            }
                                        }
                                    ...
                                    Log.e("Problem initializing layer");
                                }
                            }
                        })
